...
from .forms import WifiForm, EmailForm
...
class StudentEmailForm(LoginRequiredMixin, View):
    ...
    def get(self, request):
        ...
        try:
            ...
            if email_data:
                return render(request, 'wifi/studentemailform.html', {"user": user, "details": details, "email_data": email_data})
        except BaseException:
            return render(request, 'wifi/studentemailform.html', {"user": user, "details": details})
