...
def student_profile_complete(function):
    ...
    def wrapper(request, *args, **kwargs):
        ...
        if user.first_name == "" or user.email == "" or profile.course is None or profile.branch is None or profile.year is None or profile.contact_no is None or profile.address is None or profile.father_name is None:
