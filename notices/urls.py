...
from notices.views import NoticeList, NoticeShow, NoticeCreateView, NoticeUpdateView, NoticeDeleteView, BookmarkCreateView,  BookmarkDeleteView, BookmarkListView
