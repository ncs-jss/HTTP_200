...
from notices.views import NoticeList, NoticeShow, CreateNotice, NoticeUpdateView, NoticeDeleteView, BookmarkCreateView,  BookmarkDeleteView, BookmarkListView, PinCreateView
